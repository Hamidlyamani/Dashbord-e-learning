...
type ChartSmallProps = {
    type: string
    number: number
    text: string
    width: number
}
export function Chart_Exomple({ type, number, text, width }: ChartExampleProps) {
    ...
    const chartDatapassed = [
        { type: type, number: number, fill: fill, bg_border: 'yallow', text: '70', width: 21 },
    ]
    return (
