        ...
        <div className=" ">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center my-2">
              ...
              <label htmlFor="cours" className="ml-2 text-[15px]">Cours</label>
            </div>
            <div className="flex items-center my-2">
              <input type="checkbox" id="examens" className="form-checkbox" checked />
              <label htmlFor="examens" className="ml-2 bg-[#af52de49] p-1 rounded-[8px]">Examens</label>
            </div>
            <div className="flex items-center my-2">
              <input type="checkbox" id="devoirs" className="form-checkbox" />
              <label htmlFor="devoirs" className="ml-2 bg-[#a2845e69] p-1 rounded-[8px]">Devoirs</label>
            </div>
            <div className="flex items-center my-2">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center my-2">
              ...
              <label htmlFor="maths" className="ml-2 bg-[#FFE6CA] p-1 rounded-[8px]">Maths</label>
            </div>
            <div className="flex items-center my-2">
              <input type="checkbox" id="physique" className="form-checkbox" checked />
              <label htmlFor="physique" className="ml-2 bg-[#FEE3E2] p-1 rounded-[8px]">Physique</label>
            </div>
            <div className="flex items-center my-2">
              <input type="checkbox" id="economie" className="form-checkbox" />
              <label htmlFor="economie" className="ml-2 bg-[#DCFFE7] p-1 rounded-[8px]">Économie</label>
            </div>
          </div>
