        ...
        <>
            <div className={`message received group flex gap-2 relative w-1/2 ${ data.isMe?" ml-auto flex flex-col justify-end items-end":""} `}>
                ...
                <div >
                    ...
                    <div className={`my-2 border rounded-tl-[0] rounded-[14px] p-4 py-3 text-[18px] shadow-[0_1px_4px_rgba(0,0,0,0.15)] ${data.isMe ?" bg-blue text-white rounded-tr-[0]rounded-tr-[0] rounded-[14px]":""}`}>
                        <p>
                            {data.text}
                        </p>
