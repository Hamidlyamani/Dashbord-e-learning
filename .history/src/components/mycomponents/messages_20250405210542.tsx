            ...
            <div className={`message received group flex gap-2 relative w-fit max-w-1/2 ${ data.isMe?" ml-auto flex flex-col justify-end items-end":""} `}>
                ...
                <div >
                    ...
                    {!data.isMe ? <>  <button onClick={() => setIsOpen(!isOpen)} className="absolute cursor-pointer  -right-16 top-14 -translate-y-1/2 bg-gray-200 text-gray-600 px-2 py-1 rounded-lg text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button className="absolute -left-16 top-14 -translate-y-1/2 cursor-pointer  bg-gray-200 text-gray-600 px-2 py-1 rounded-lg text-sm opacity-0 group-hover:opacity-100 transition-opacity">
