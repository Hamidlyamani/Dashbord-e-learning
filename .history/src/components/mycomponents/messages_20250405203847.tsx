        ...
        <>
            <div className="message received group flex gap-2 relative w-fit">
                {data.isMe ? '' : <img src={data.user_img} alt='' className=" object-cover w-[50px] h-[50px] rounded-full" />}
                  <div >
                    <div className="flex gap-2 items-end ">{!data.isMe ?  <p className="font-Urb_medium  text-[#515151]">{data.user}</p> <p className="text-[12px] text-[#A0A0A0] pb-0.25 ">10:30 AM</p></div>
