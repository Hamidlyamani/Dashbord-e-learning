                ...
                <div className="px-5 py-4">
                    ...
                    <div className="resultat mt-2">
                        ...
                        <div className="flex justify-between my-1">
                            ...
                            <div className="butten bg-blue text-white flex items-center gap-2 rounded-[7px] px-3 py-1 text-[10px] font-urb_bold"> Continuer <span className='block border-t w-[5px] h-[5px]  border-white border-r rotate-45'></span></div>
                        </div>
                    </div>
                </div>
            </div>
