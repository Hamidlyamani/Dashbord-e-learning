        ...
        <>
            <div className="w-1/3 bg-white rounded-[15px]">
                ...
                <div className="px-5 py-4">
                    <div className="">
                        <div className="flex justify-between"><h5 className='font-urb_bold text-[20px]'>{details.title}</h5><div className="chart w-"><img src={details.chart_cours} alt="" /></div></div>
                    </div>
