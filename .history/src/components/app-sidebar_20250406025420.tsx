        ...
        <div className=" ">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center my-1">
              ...
              <label htmlFor="examens" className="ml-2 bg-purple-200 p-1 rounded-[8px]">Examens</label>
            </div>
            <div className="flex items-center my-1">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center my-1">
              ...
              <label htmlFor="physique" className="ml-2 text-light_green">Physique</label>
            </div>
            <div className="flex items-center my-1">
          ...
          <div>
            ...
            <div className="flex items-center my-1">
              ...
              <label htmlFor="cours_periode" className="ml-2 bg-pink-200 p-1 rounded-[8px]">Cours</label>
            </div>
            <div className="flex items-center my-1">
              <input type="checkbox" id="conges" className="form-checkbox" checked />
              <label htmlFor="conges" className="ml-2 bg-green-200 p-1 rounded-[8px]">Congés</label>
            </div>
            <div className="flex items-center my-1">
              <input type="checkbox" id="alternance" className="form-checkbox" />
              <label htmlFor="alternance" className="ml-2 bg-green-200 p-1 rounded-[8px]">Alternance</label>
            </div>
          </div>
        </div>
      </SidebarContent>
