    ...
    <Sidebar {...props}>
      ...
      <SidebarContent>
        ...
        <div className=" ">
          ...
          <div className="mb-6">
            <h3 className="text-[15px] font-Urb-bold text-[#71809520]">Types</h3>
            ...
            <div className="flex items-center my-2">
              ...
              <label htmlFor="examens" className="ml-2 bg-[#AF52DE] p-1 rounded-[8px]">Examens</label>
            </div>
            <div className="flex items-center my-2">
              <input type="checkbox" id="devoirs" className="form-checkbox" />
              <label htmlFor="devoirs" className="ml-2 bg-[#A2845E] p-1 rounded-[8px]">Devoirs</label>
            </div>
            <div className="flex items-center my-2">
