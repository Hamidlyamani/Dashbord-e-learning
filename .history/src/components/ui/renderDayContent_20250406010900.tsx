        ...
        <div className="flex flex-col items-end justify-start p-1 gap-1 text-[10px]">
            ...
            {events.map((event, idx) => (
                <div
                    ...
                    className={cn(
                        event.color,
                        "rounded-[10px] text-white px-2 py-1 w-full text-left text-[8px] shadow-md"
                    )}
                >
                    ...
                    <div className="text-[7px]">{event.prof}</div>
                        ...
                        <a href=""><span className="block w-1 h-1 rotate-45 border-t border-r border-white "></span></a>
                    </div>
                </div>
            ))}
        </div>
